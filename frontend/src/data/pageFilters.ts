...
export const pageFilterConfigs: Record<string, FilterField[]> = {
  overview: [
    { key: 'schema', label: 'Schema', type: 'select', options: SCHEMA_OPTIONS, column: 'schema_name' },
    { key: 'state', label: 'State', type: 'select', options: STATE_OPTIONS, column: 'state_name' },
    { key: 'district', label: 'District', type: 'select', options: DISTRICT_OPTIONS, column: 'district_name' },
    { key: 'status', label: 'Status', type: 'select', options: STATUS_OPTIONS, column: 'case_status' },
  ...
  bis: [
    { key: 'state', label: 'State', type: 'select', options: STATE_OPTIONS, column: 'state_name' },
    { key: 'district', label: 'District', type: 'select', options: DISTRICT_OPTIONS, column: 'district_name' },
    { key: 'status', label: 'Card Print Status', type: 'select', options: STATUS_OPTIONS, column: 'card_print_status' },
  ...
  mh: [
    { key: 'state', label: 'State', type: 'select', options: STATE_OPTIONS, column: 'patient_state_name' },
    { key: 'district', label: 'District', type: 'select', options: DISTRICT_OPTIONS, column: 'patient_district_name' },
    { key: 'status', label: 'Case Status', type: 'select', options: STATUS_OPTIONS, column: 'case_status' },
  ...
  mp_hospitals: [
    ...
    { key: 'status', label: 'Empanelment Status', type: 'select', options: STATUS_OPTIONS, column: 'empanelment_status' },
  ],
  mp_patients: [
    { key: 'district', label: 'District', type: 'select', options: DISTRICT_OPTIONS, column: 'district_name' },
    { key: 'status', label: 'Patient Status', type: 'select', options: STATUS_OPTIONS, column: 'patient_status' },
    { key: 'date_from', label: 'Admission From', type: 'date', column: 'admission_dt' },
    { key: 'date_to', label: 'Admission To', type: 'date', column: 'admission_dt' },
  ],
  mp_fraud: [
    ...
    { key: 'status', label: 'Investigation Status', type: 'select', options: STATUS_OPTIONS, column: 'investigation_status' },
  ],
  mp_users: [
    ...
    { key: 'status', label: 'User Status', type: 'select', options: STATUS_OPTIONS, column: 'user_status' },
  ],
  mp_lms: [
    { key: 'course', label: 'Course', type: 'select', options: COURSE_OPTIONS, column: 'course_name' },
    { key: 'status', label: 'Completion Status', type: 'select', options: STATUS_OPTIONS, column: 'completion_status' },
  ],
  ump: [
    { key: 'state', label: 'State', type: 'select', options: STATE_OPTIONS, column: 'state_name' },
    { key: 'role', label: 'Role', type: 'select', options: ROLE_OPTIONS, column: 'role' },
...
// Maps filter keys to actual row keys in mock table data
