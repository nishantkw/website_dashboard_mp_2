  ...
  return (
    <div className="flex shrink-0 flex-col items-center">
      ...
      <select
        ...
        className={`rounded-lg border px-2.5 py-1.5 text-xs outline-none transition-all ${
          wide ? 'min-w-[168px] max-w-[220px]' : 'min-w-[118px] max-w-[148px]'
        } ${
          disabled
            ? 'cursor-not-allowed border-[#dceee3] bg-slate-50 text-slate-400'
            : active
            ? 'cursor-pointer border-[#2d8a4e] bg-[#edf7f0] font-semibold text-[#1a5c38] shadow-sm shadow-emerald-900/5'
            : 'cursor-pointer border-[#c5e0ce] bg-white text-slate-700 hover:border-[#2d8a4e]/60 hover:shadow-sm'
