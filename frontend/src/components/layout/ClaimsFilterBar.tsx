...
export default function ClaimsFilterBar({
  ...
  onClear,
  activeCount,
  subtitle = 'Master Report TMS Claim filters',
    ...
    <div className="mb-5 rounded-xl border border-[#b8dcc4] bg-white shadow-[0_4px_20px_-4px_rgba(26,92,56,0.18)]">
      ...
      <div className="scrollbar-visible flex gap-2.5 overflow-x-auto px-3 pb-3 pt-3 sm:px-4">
        ...
        {textFields.map((field) => (
          <div key={field.key} className="flex shrink-0 flex-col items-center">
            ...
            <input
              ...
              placeholder={field.label}
              className="min-w-[130px] rounded-lg border border-[#c5e0ce] bg-white px-2.5 py-1.5 text-xs outline-none focus:border-[#2d8a4e]"
            />
          </div>
        ))}
        <DateRangeFilter
